    ...
    <div className="relative">
      <nav className="fixed top-0 left-0 right-0  w-full z-30 flex flex-wrap justify-between items-center font-bold text-[15px] py-6 max-sm:px-10 px-[100px] bg-[#070737] text-[#f1f1f1] overflow-hidden">
        ...
        <div className="max-sm:hidden md:hidden lg:flex flex-wrap max-sm:items-center max-sm:z-30 max-sm:absolute top-[0px]   max-sm:w-[190px] max-sm:h-[100px] left-[200px] flex max-sm:flex-col  justify-center gap-4 ">
          ...
          <button className="max-sm:px-1 max-sm:py-1 max-sm:w-[80px] px-10 lg:py-2 bg-[#f1f1f1] text-[#0f0f5f] hover:bg-[#070737] border-2 border-slate-300 hover:text-[#f1f1f1] max-sm:text-[10px] text-[15px] transition-all duration-300 ease-in-out">
            join-us
          </button>
        </div>
      ...
      {/* mobile menu */}
      {isOpen && (
        <div className="max-w-[400px] pt-[90px] bg-[#070737] text-[#fff] w-full">
          ...
          {/* Donate section */}
          <div className="max-w-[360px] flex flex-col gap-y-2 mt-2 py-2">
            <Link
              to={`/Donate`}
              className="max-sm:px-1 max-sm:py-1 max-sm:w-[80px] px-10 lg:py-2
            bg-[#070737] text-[#f1f1f1] border-2 border-slate-300
