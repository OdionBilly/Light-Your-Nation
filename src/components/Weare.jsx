...
export const Weare = () => {
  ...
  return (
    <div className="">
      <h1 className="py-2 font-merriweather text-[30px] text-left lg:text-[48px] ml-[50px] lg:ml-20">
        A Brief History{" "}
      </h1>{" "}
      <div className="flex justify-between align-baseline max-sm:flex-col text-[#fff] ">
        <p className=" lg:text-[20px] ml-0 lg:ml-[80px] px-5 lg:px-5 mt-4 w-[100%] bg-slate-500 py-10 lg:py-[70px]">
      ...
      <div className="overflow-hidden flex flex-col md:flex-col lg:flex-row gap-10">
        ...
        <div className="ml-[10px] mt-10 md:mt-5 lg:mt-10 flex flex-col md:flex-row lg:flex-col md:gap-5 xl:gap-0">
